...
|---|------------------|--------|-------------------|
| Success Criteria #1 | proposePatch unified diff + 5-key 인라인 legend visible | **FULL PASS** (v1.2 hotfix F-12 적용 후) | 라이브 검증: 텍스트 답변 DOM render + mutating 질의 시 5-key 카드 + 인라인 legend visible 사용자 시각 확인 (2026-05-07 v1.2). nonce=`8a7aa467-ea49-4ac5-9c1f-422d954846d2` apply commit `e79d2f0`. F-12 fix: `htmx:sseOpen` hook으로 EventSource에 직접 named event listener 부착. |
